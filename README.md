...
```console
admin@MacBook-Pro-Admin ~ % neofetch
                    'c.          admin@MacBook-Pro-Admin.local
                 ,xNMM.          -----------------------------
               .OMMMMo           OS: macOS 15.7.4 24G517 x86_64
               OMMM0,            Host: MacBookPro15,2
     .;loddo:' loolloddol;.      Kernel: 24.6.0
   cKMMMMMMMMMMNWMMMMMMMMMM0:    Uptime: 11 hours, 22 mins
  ...
  .XMMMMMMMMMMMMMMMMMMMMMMMMK.   Terminal Font: Monaco 12
    kMMMMMMMMMMMMMMMMMMMMMMd     CPU: Intel i5-8279U (8) @ 2.40GHz
     ;KMMMMMMMWXXWMMMMMMMk.      GPU: Intel Iris Plus Graphics 655
       .cooc,.    .,coo:.        Memory: 9180MiB / 16384MiB
